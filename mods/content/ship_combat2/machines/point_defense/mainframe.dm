/obj/machinery/point_defense
	icon = 'mods/content/ship_combat2/icons/pointdefensemainframe.dmi'
...
/obj/machinery/point_defense/point_defense_computer/on_update_icon()
	...
	if(sensor_integrity <= 0)
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "mim_status_offline")
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "pdc_screen_offline")

	if(sensor_integrity <= 25)
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "mim_status_25")
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "pdc_screen_alert")

	if(sensor_integrity <= 50)
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "mim_status_50")
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "pdc_screen_caution")

	if(sensor_integrity <= 75)
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "mim_status_75")
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "pdc_screen_norm")

	if(sensor_integrity == 100)
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "mim_status_100")
		overlays += image('mods/content/ship_combat2/icons/pointdefensemainframe.dmi', "pdc_screen_norm")
